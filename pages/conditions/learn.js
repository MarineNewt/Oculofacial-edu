  ...
  return (
    <Layout name="Learn" current="Conditions">
      ...
      <div className={styles.primaryContent}>
        ...
        <Link href="/conditions/ptosis" className={styles.none}><h3>Ptosis</h3></Link>
        <Link href="/conditions/dermatochalasis" className={styles.none}><h3>Dermatochalasis</h3></Link>
        <Link href="/conditions/chalazion" className={styles.none}><h3>Chalazion</h3></Link>
        </div>
      </div>
      <h2>
